...
#ifndef _SBE_SNAPSHOTFULLREFRESH_ORDERS_MBO_71_CXX_H_
#define _SBE_SNAPSHOTFULLREFRESH_ORDERS_MBO_71_CXX_H_
...
public:
    ...
    static constexpr std::uint16_t SBE_SCHEMA_VERSION = static_cast<std::uint16_t>(8);
    static constexpr const char* SBE_SEMANTIC_VERSION = "1.7.0";
